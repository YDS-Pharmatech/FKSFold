...
from chai_lab.data.sources.pdb import PDBConformerGenerator
...
def load_chains_from_raw(
    ...
    if tokenizer is None:
        if pdb_conformer_path is None:
            tokenizer = AllAtomResidueTokenizer(RefConformerGenerator())
        else:
            tokenizer = AllAtomResidueTokenizer(PDBConformerGenerator(pdb_conformer_path))
