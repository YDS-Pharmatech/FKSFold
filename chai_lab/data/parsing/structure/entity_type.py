...
def get_entity_type_name(entity_type_value: int) -> str:
    """Convert entity type value to human-readable name using standard EntityType enum."""
    try:
        entity_type = EntityType(entity_type_value)
        return entity_type.name
    except ValueError:
        return f"UNKNOWN({entity_type_value})"