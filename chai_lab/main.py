...
from chai_lab.chai1_internal_hack import run_inference as run_inference_hack
...
def cli():
    app = typer.Typer()
    app.command("fold_chai", help="Run Chai-1 to fold a complex.")(run_inference)
    app.command("fold", help="Run FKSFold to fold a complex.")(run_inference_hack)
    app.command(
        "a3m-to-pqt",
